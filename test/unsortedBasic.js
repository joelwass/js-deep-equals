...
test('objects equal', t => {
  t.true(compareUnsorted(constants.aObject, constants.bObject))
})

test('objects not equal', t => {
  t.false(compareUnsorted(constants.aObject, constants.cObject))
})
